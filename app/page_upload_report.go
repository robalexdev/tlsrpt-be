...
func handleUploadReport(c *gin.Context, db *gorm.DB, user *User) {
	view := View{c}
...
func rejectUploadReport(user *User, errorMsg string, c *gin.Context) {
...
func handleShowUploadReport(c *gin.Context, db *gorm.DB, user *User) {
	view := View{c}
