...
func handleShowAddDomain(c *gin.Context, db *gorm.DB, user *model.User) {
	c.HTML(http.StatusOK, "add_domain.tmpl", gin.H{
		"user": user,
	})
}

func handleAddDomain(c *gin.Context, db *gorm.DB, user *model.User) {
